1. ## 综述--关于大模型在数据合成、符号推理等方面的综述性论文。
   ...
   8. [Synthetic Data Privacy Metrics: A Survey](https://arxiv.org/abs/2501.01234) *arXiv Survey 2025*  

      系统综述合成数据隐私度量方法，包括重识别风险、差分隐私测度、攻击模拟等工具和指标。 
   ...
   *将语言的内容逻辑抽象出来再进行有效推理*
   ...
   ### benchmark/ 指标 / Evaluation Framework

   1. [GenAIPABench: A Benchmark for Generative AI–based Privacy Assistants]([[2309.05138\] GenAIPABench：基于生成式人工智能的隐私助手的基准](https://arxiv.org/abs/2309.05138)) *PoPETS 2024（安全类的ccf c，但是在隐私方向上有b的水平，安全的发文难度比ai的高一些）*  
      构建生成式 AI 隐私助手 benchmark，覆盖透明性、用户控制、数据最小化等维度，为隐私合成数据和 AI 工具提供标准化评测框架。
   2. [NIST SP 800-226: Guidelines for Evaluating Differential Privacy Guarantees](https://doi.org/10.6028/NIST.SP.800-226) *Journal of Research of NIST*  
      官方差分隐私评估标准，涵盖实验设计、攻击模拟和度量指标，可用于合成数据隐私审计。
   3. [Synthetic Data Privacy Metrics]([合成数据隐私指标](https://arxiv.org/html/2501.03941v1)) *arxiv 2025*  未读
   4. [A consensus privacy metrics framework for synthetic data](https://www.sciencedirect.com/science/article/pii/S2666389925001680)*cell press2025*未读
